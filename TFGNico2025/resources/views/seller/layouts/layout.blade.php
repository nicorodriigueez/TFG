		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Seller Dashboard</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{request()->routeIs('vendor') ? 'active' : ''}}"> <!-- asignamos la clase active a la ruta Vendor-->
						<a class="sidebar-link" href="{{route('vendor')}}">
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
            </a>
					</li>

						<li class="sidebar-item {{request()->routeIs('vendor.order.history') ? 'active' : ''}}"> <!-- asignamos la clase active a la ruta Vendor-->
